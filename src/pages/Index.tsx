...
import { ArrowRight, Shield, Users, FileCheck, Truck, ChevronRight, LogOut } from "lucide-react";
        ...
        <div className="container mx-auto px-4 py-16">
          <div className="text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button onClick={handleGoToDashboard} size="lg" className="bg-emerald-600 hover:bg-emerald-700">
                Go to Dashboard
